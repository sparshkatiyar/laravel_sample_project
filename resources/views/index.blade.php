        ...
        <div class="carousel-cell">
            <div class="slider-box">
                ...
                <div class="box">
                    ...
                    <!--  -->
                    <div class="img">
                        <a href="../Pandit-profile/profile.html"> <img src="{{ asset('images/img1.png') }}" alt="#"
                                width="90px"></a>
    ...
    <div class="container-fluid text-center p-0">
        ...
        <div class="main">
            ...
            <div id="myBtnContainer" class="tabs_title">
                ...
                <button class="btn remove-active" data-name="cars"> Online Pooja</button>
                <button class="btn ative-class" data-name="people"> On Request Special Pooja</button>
            </div>
            ...
            <div class="row tabs_content">
                <div class="column show nature">
                    ...
                    <div class="content">
                        ...
                        <button id="heart"><img src="https://cdn-icons-png.flaticon.com/512/1077/1077035.png" alt="#"
                                style="width: 20px !important; height:20px;"></button>
                    </div>
                </div>
