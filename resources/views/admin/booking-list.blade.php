...
<body class="layout-row">
                    ...
                    <div class="padding">
                                        ...
                                        <tr class="v-middle" data-id="20">
                                            ...
                                            <td>
                                                <span class="item-amount d-none d-sm-block text-sm">
                                                    {{$user->price_total}}/-</span>
                                            </td>
                                            <td>
                                                <div class="item-date text-muted text-sm d-none d-md-block">
                                                    <a class="item-badge badge text-uppercase bg-success"
                                                        onclick="addressDetails({{$user->address_id}})">
                                                        see details
                                                    </a>
                                                </div>
                                            </td>
                                            <td class="no-wrap">
                                                <div class="item-date text-muted text-sm d-none d-md-block">
                                                    <a class="item-badge badge text-uppercase bg-success"
                                                        onclick="userDetails({{$user->user_details}})">
                                                        see details
                                                    </a>
                                                </div>
                                            </td>
                                            ...
                                            <td class="no-wrap">
                                                <div class="item-date text-muted text-sm d-none d-md-block">
                                                    ...
                                                    <button value="{{$user->id}}"
                                                        class="btn w-sm mb-1 btn-outline-warning assing">
                                                        assign pandit
                                                    </button>
                                                    @endif
                        ...
                        <div id="modalToast" class="modal fade" data-backdrop="false">
                            <div class="modal-dialog">
                                <div class="alert alert-success" role="alert"><svg xmlns="http://www.w3.org/2000/svg"
                                        width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor"
                                        stroke-width="2" stroke-linecap="round" stroke-line join="round"
                                        class="feather feather-check">
                                        <polyline points="20 6 9 17 4 12"></polyline>
                                    </svg> <span class="mx-2">Pandit assign to ecoomerce puja is successful !!</span>
                                </div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body p-4">
                    <form action="{{url('admin-panel/assing-pandit')}}" method="post">
                        ...
                        <div class="form-row">
                            <div class="form-group col-md-12">
                                <label for="inputState" class="text-muted d-block">Pandit</label>
                ...
                <div class="modal-body p-4">
                    <form>
                        <div class="form-row">
                            ...
                            <div class="form-group col-md-6">
                                <label class="text-muted">Contact Number</label><input type="text" class="form-control"
                        ...
                        <div class="form-row">
                            <div class="form-group col-md-6">
                                <label class="text-muted">City <small></small></label><input type="text" id="city"
    ...
    $(document).ready(function() {
        ...
        if (!$(event.target).closest('#pandit').length) {
