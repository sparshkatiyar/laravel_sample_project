                ...
                <div class="page-hero page-container" id="page-hero">
                    <div class="padding d-flex">
                        <div class="page-title">
                            <h2 class="text-md text-highlight">Request List</h2>
                            <small class="text-muted">Astropandit have puja request </small>
                        </div>
                        <div class="flex"></div>
                        <!-- <div>
                            <a href="{{url('admin-panel/puja-creation')}}" class="btn btn-md text-muted"><span
                                    class="d-none d-sm-inline mx-1">See pooja request</span>
                                ...
                                <table class="table table-theme table-row v-middle">
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="text-muted" style="width: 120px">City</th>
                                            <th class="text-muted" style="width: 120px">Location</th>
                                            <th class="text-muted" style="width: 120px">Message</th>
                                        ...
                                        <tr class="v-middle" data-id="20">
                                            ...
                                            <td class="flex">
                                                <a href="page.invoice.detail.html"
                                                    class="item-company ajax h-1x">{{$puja->email}}</a>
                                            ...
                                            <td>
                                                ...
                                                <span class="item-company ajax h-1x">{{@$puja->phone}}</span>
                                            ...
                                            <td>
                                                <div class="item-action dropdown">
                                                    ...
                                                    <div class="dropdown-menu dropdown-menu-right bg-black" role="menu">
                                                        <a class="dropdown-item" onclick="poojaDetails({{$puja}})">See
                                                            details </a>
                                                        <a href="{{'puja-edit'}}/{{$puja->id}}"
                                                        ...
                                                        <a class="dropdown-item trash"
                                                            href="{{'puja-delete'}}/{{$puja->id}}"
                                                            onclick="return confirm('Are you sure you want to delete this pooja')">Delete
                                                            Pooja</a>
                                                    </div>
                                                </div>
                                            </td>
                    ...
                    <form>
                        <div class="form-row">
                            <div class="form-group col-md-6">
                                <label class="text-muted"> Name</label><input type="text" class="form-control" id="name"
                                    placeholder="Name" />
                            </div>
                            <div class="form-group col-md-6">
                                <label class="text-muted">Image</label><input type="text" class="form-control"
                                    placeholder="Last name" id="image" />
                            </div>
                        </div>
                        <div class="form-row">
                            <div class="form-group col-md-6">
                            ...
                            <div class="form-group col-md-6">
                                <label class="text-muted">Type</label><input type="text" class="form-control"
                                    placeholder="Last name" id="type" />
                            </div>
