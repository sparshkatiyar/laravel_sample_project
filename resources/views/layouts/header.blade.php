 ...
 <!-- --------navbar---- -->
    <div class="container-fluid b-navbar">
        <div class="img-div">
            ...
            <a href="javascript:void(0)" class="ds-add"><img src="{{ asset('images/menu-slide.png')}}" alt=""></a>
        </div>
        ...
        <div class="menu-div dsk-menu">
            <div class="contact-div top-header">
                <div class="item1">
                    ...
                    <p>  <img src="https://img.icons8.com/ios/2x/apple-phone.png" alt="#" width="20px" /><a href="tel:+91 88106 40406 "> +91 88106 40406</a></p>
                    
                    <p><img src="https://img.icons8.com/ios/2x/apple-mail.png" alt="#" width="25px" /><a href="mailto:info@astropanditom.com">  info@astropanditom.com</a></p>
                </div>
                <div class="item2">
                     <div>
...
<div class="mobile-menu2">
   <a href="javascript:void(0)" class="header-close"><img src="{{ asset('images/cross-icon.png')}}" alt=""></a>
     <div class="menu-div">
