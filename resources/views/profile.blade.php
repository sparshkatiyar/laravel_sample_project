            ...
            <div class="second-div">
                ...
                <div class="all-content">
                    ...
                    <div class="form">
                        ...
                        <div class="col2">
                            <input type="text" placeholder="Rajesh Shukla">
                        </div>
                        <!-- --- -->
                        <div class="col">
                            <h4>Mobile No :</h4>
                        ...
                        <div class="col2">
                            <input type="text" placeholder="rajesh.shukla@gmail.com">
                        </div>
                        <!-- --- -->
                        <div class="col">
                            <h4>Birth Date</h4>
                        ...
                        <div class="col2">
                            <input type="date" placeholder="11 March, 1999">
                        </div>
                        ...
                        <div class="col double">
                            <div>
                                ...
                                <div class="col2">
                                    <input type="time" placeholder="11 March, 1999">
                                </div>
                            </div>
                            <div>
                                <div class="col">
                                ...
                                <div class="col2">
                                    <input type="text" placeholder="11 March, 1999">
                                </div>
                            </div>
                        ...
                        <div class="col double">
                            ...
                            <div style="display: flex; align-items:center;"> <input type="radio" name="gender"
                                    style="width: 20px; "> &nbsp; <b>Male</b>&nbsp;&nbsp;&nbsp; <input type="radio"
                                    name="gender" style="width: 20px; "> &nbsp; <b>Female</b> </div>
