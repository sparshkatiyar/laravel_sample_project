 ...
 <div class="main">
     ...
     <div class="row">
       <div class="column nature">
         <div class="content">
          <a href="Pooja-1/pooja-book.html"> <img src="{{ asset('puja/god-img1.png')}}" alt="Mountains" style="width:100%"></a>
          <a href="Pooja-1/pooja-book.html"> <h4>Akhand Ramayan (Musical)</h4></a>
           <p>INR-2100/-</p>
         </div>
       </div>
...
<a href="">           <img src="{{ asset('puja/god-img2.png')}}" alt="Mountains" style="width:100%"></a>
       ...
       <div class="column cars">
         <div class="content">
<a href="">           <img src="{{ asset('puja/god-img1.png')}}" alt="Mountains" style="width:100%"></a>
           <h4>Akhand Ramayan (Musical)</h4>
           <p>INR-2100/-</p>
         </div>
       </div>
...
<a href="">           <img src="{{ asset('puja/god-img2.png')}}" alt="Mountains" style="width:100%"></a>
 ...
 <section id="about-section">
     ...
     <div class="container-fluid about">
        ...
        <p>
            Lorem ipsum dolor sit amet, consectetur adipiscing elit. Vestibulum eget magna tempus hendrerit scelerisque amet. Natoque pretium
            sit pretium donec eget duis sit in pretium. Laoreet sed nisl, porta nisl nunc scelerisque ipsum cursus. Vitae lectus lorem varius at a.
            sit pretium donec eget duis sit in pretium
            <br>
            <br>
            Lorem ipsum dolor sit amet, consectetur adipiscing elit. Vestibulum eget magna tempus hendrerit scelerisque amet. Natoque pretium
            sit pretium donec eget duis sit in pretium. Laoreet sed nisl, porta nisl nunc scelerisque ipsum cursus. Vitae lectus lorem varius at a.
            sit pretium donec eget duis sit in pretium Lorem ipsum dolor sit amet, consectetur adipiscing elit. Vestibulum eget magna tempus 
            sit pretium donec eget duis sit in pretium. Laoreet sed nisl, porta nisl nunc scelerisque ipsum cursus. Vitae lectus lorem varius at a.
            sit pretium donec eget duis sit in pretium
        </p>
    </div>
