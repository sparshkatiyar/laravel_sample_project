...
$(document).ready(function() {
    ...
    $("#samgari").click(function() {
        ...
        if (ptype == 1) {
            totalPrice = parseInt("{{$pujaDetails->puja_price_samall}}") + parseInt(basePrice) +
                parseInt("{{$pujaDetails->puja_samagri_price}}");
        } else if (ptype == 2) {
            totalPrice = parseInt("{{$pujaDetails->puja_price_medium}}") + parseInt(basePrice) +
                parseInt("{{$pujaDetails->puja_samagri_price}}");
        } else if (ptype == 3) {
            totalPrice = parseInt("{{$pujaDetails->puja_price_large}}") + parseInt(basePrice) +
                parseInt("{{$pujaDetails->puja_samagri_price}}");
        } else {
    ...
    $("#wsamgari").click(function() {
        ...
        if (ptype == 1) {
            totalPrice = parseInt("{{$pujaDetails->puja_price_samall}}") + parseInt(basePrice) +
                parseInt("{{$pujaDetails->puja_wsamagri_price}}");
        } else if (ptype == 2) {
            totalPrice = parseInt("{{$pujaDetails->puja_price_medium}}") + parseInt(basePrice) +
                parseInt("{{$pujaDetails->puja_wsamagri_price}}");
        } else if (ptype == 3) {
    ...
    $("#all").click(function() {
        ...
        if (ptype == 1) {
            totalPrice = parseInt("{{$pujaDetails->puja_price_samall}}") + parseInt(basePrice) +
                parseInt("{{$pujaDetails->puja_price_all}}");
        } else if (ptype == 2) {
            totalPrice = parseInt("{{$pujaDetails->puja_price_medium}}") + parseInt(basePrice) +
                parseInt("{{$pujaDetails->puja_price_all}}");
        } else if (ptype == 3) {
